  ...
  return (
    <div className="main">
      <div className="terms">
        ...
        <p>
          Welcome to IMDb. IMDb.com, Inc. and/or its affiliates ("IMDb") provide
          its website features and other services to you subject to the
          following conditions.{" "}
          <strong>
            If you visit IMDb.com, use other IMDb services, products, or use
            software or mobile applications provided by IMDb that states that it
            is subject to these Conditions of Use (collectively “IMDb
            Services”), you accept these conditions.
          </strong>{" "}
          Please read them carefully. In addition, when you use any current,
          future IMDb Services, (e.g., IMDbPro.com) you also will be subject to
          the guidelines, terms and agreements (“Terms”) applicable to that IMDb
          Service. If these Conditions of Use are inconsistent with the Terms
          provided for any IMDb service, the Terms will control.
        </p>
        ...
        <section>
          ...
          <h2>Privacy</h2>
          <p>
            Please review our <a href="/privacy?ref_=cou_1">Privacy Notice</a>,
            which also governs your use of any IMDb Service, to understand our
            practices.
          </p>
          ...
          <p>
            ...
            please visit our{" "}
            <a href="http://www.imdb.com/licensing/">
            ...
            . We do allow the limited use of robots and crawlers, such as those
            from certain search engines, with our express written consent. If
            you are interested in receiving our express written permission to
            use robots or crawlers on our site, please{" "}
            <a href="http://www.imdb.com/licensing/">
              contact our Licensing Department
            </a>
            .
          ...
          <p>
            <strong>Linking to IMDb.com:</strong> You are granted a limited,
            revocable, and nonexclusive right to create a hyperlink to IMDb.com
            so long as the link follows our{" "}
            <a href="https://help.imdb.com/article/imdb/general-information/how-do-i-link-to-a-specific-page-on-your-site/GTRTF6K8UA9JP9QQ">
              {" "}
              linking guide
            </a>{" "}
            and does not portray IMDb, its services in a false, misleading,
            derogatory, or otherwise offensive matter. You may not use any IMDb
            logo or other proprietary graphic or trademark as part of the link
            without express written permission except as outlined in our{" "}
            <a href="https://help.imdb.com/article/imdb/general-information/how-do-i-link-to-a-specific-page-on-your-site/GTRTF6K8UA9JP9QQ">
              help section
            </a>
            .
          ...
          otherwise injurious to third parties or objectionable, is not created
          by generative AI, and does not consist of or contain software viruses,
          ...
          the origin of your content. IMDb reserves the right (but not the
          ...
          <p>
            ...
            review our <a href="/privacy?ref_=cou_7">Privacy Notice</a>.
          </p>
          ...
          <p>
            IMDb's Copyright Agent for notice of copyright infringement on it
          ...
          <p>
            In appropriate circumstances, IMDb will terminate the accounts of
            account holders who are repeat infringers.
          </p>
          <h2>Disclaimer of Warranties and Limitation of Liability</h2>
          <blockquote>
            <p>
              THE IMDB SERVICES AND ALL INFORMATION, CONTENT, MATERIALS,
              PRODUCTS (INCLUDING SOFTWARE) AND OTHER SERVICES INCLUDED ON OR
              OTHERWISE MADE AVAILABLE TO YOU THROUGH THE IMDB SERVICES ARE
              PROVIDED BY IMDB ON AN "AS IS" AND "AS AVAILABLE" BASIS. IMDB
              MAKES NO REPRESENTATIONS OR WARRANTIES OF ANY KIND, EXPRESS OR
              IMPLIED, AS TO THE OPERATION OF THE IMDB SERVICES OR THE
              ...
              THROUGH THE IMDB SERVICES. YOU EXPRESSLY AGREE THAT YOUR USE OF
              THE IMDB SERVICES IS AT YOUR SOLE RISK. IMDB RESERVES THE RIGHT TO
              WITHDRAW ANY IMDB SERVICE OR DELETE ANY INFORMATION FROM THE IMDB
              SERVICES AT ANY TIME IN ITS DISCRETION.
            </p>

            <p>
              TO THE FULL EXTENT PERMISSIBLE BY APPLICABLE LAW, IMDB DISCLAIMS
              ALL WARRANTIES, EXPRESS OR IMPLIED, INCLUDING, BUT NOT LIMITED TO,
              IMPLIED WARRANTIES OF MERCHANTABILITY AND FITNESS FOR A PARTICULAR
              PURPOSE. IMDB DOES NOT WARRANT THAT THE IMDB SERVICES,
              INFORMATION, CONTENT, MATERIALS, PRODUCTS (INCLUDING SOFTWARE) OR
              OTHER SERVICES INCLUDED ON OR OTHERWISE MADE AVAILABLE TO YOU
              THROUGH THE IMDB SERVICES, ITS SERVERS, OR ELECTRONIC
              COMMUNICATIONS SENT FROM IMDB ARE FREE OF VIRUSES OR OTHER HARMFUL
              COMPONENTS. IMDB WILL NOT BE LIABLE FOR ANY DAMAGES OF ANY KIND
              ARISING FROM THE USE OF ANY IMDB SERVICE, OR FROM ANY INFORMATION,
          ...
          <p>
            <strong>IMDb Software Terms</strong>
            In addition to these Conditions of Use, the terms found{" "}
            <a href="#additionalterms">here</a> apply to any software (including
            any updates or upgrades to the software and any related
            documentation) that we make available to you from time to time for
            your use in connection with IMDb Services (“IMDb Software”). If we
            provide specific Terms for the IMDb Software and there is a conflict
            between the specific Terms for the IMDb Software and these
            Conditions of Use, the specific Terms for the IMDb Software will
            govern.
          </p>
          <h2>Applicable Law</h2>
          <p>
            By using any IMDb Service, you agree that the laws of the state of
            ...
            might arise between you and IMDb.{" "}
          </p>
          <h2>Disputes</h2>
          <p>
            Any dispute or claim relating in any way to your use of any IMDb
            Service, or any products or services sold or distributed by IMDb or
            through the IMDb Services will be resolved by binding arbitration,
            rather than in court, except that you may assert claims in small
            claims court if your claims qualify. The Federal Arbitration Act and
            federal arbitration law apply to this agreement.
          </p>
          <p>
            <strong>a.</strong> There is no judge or jury in arbitration, and
            ...
            statutory damages), and must follow the terms of these Conditions of
            Use as a court would.<br></br>
          </p>
          <p>
            <strong>b.</strong> To begin an arbitration proceeding, you must
            send a letter requesting arbitration and describing your claim to
            our registered agent Corporation Service Company, 300 Deschutes Way
            SW, Suite 304, Tumwater, WA 98051. The arbitration will be conducted
            ...
            Disputes. The AAA’s rules are available at www.adr.org or by calling
            1-800-778-7879. Payment of all filing, administration and arbitrator
            fees will be governed by the AAA’s rules. We will reimburse those
          ...
          <p>
            <strong>c.</strong> You and IMDb each agree that any dispute
            resolution proceedings will be conducted only on an individual basis
            and not in a class, consolidated or representative action. If for
            any reason a claim proceeds in court rather than in arbitration you
            and IMDb each waive any right to a jury trial. You and IMDb also
          ...
          <p>
            ...
            &nbsp;use of IMDb Services. We reserve the right to make changes to
          ...
          <blockquote>
            ...
            Seattle, WA 98108-1226<br></br>
            <code>
              <a href="http://www.imdb.com?ref_=cou_9">http://www.imdb.com/</a>
            </code>
          </blockquote>
          <p>
            <br></br>
          ...
          <ol>
            <li>
              <strong>Use of the IMDb Software</strong>. You may use the IMDb
              Software only in connection with the IMDb Services. You may not
              separate any individual component of the IMDb Software for use
              other than in connection with the IMDb Services, incorporate any
              portion of it into your own programs or compile any portion of it
              in combination with your own programs, transfer it for use with
              another service, use it, or any portion of it, over a network, or
              sell, rent, lease, lend, loan, distribute or sub-license the IMDb
              Software or otherwise assign any rights to the IMDb Software in
              whole or in part. You may not use the IMDb Software for any
              illegal purpose. We may discontinue some or all of any IMDb
              Software we provide, and we may terminate your right to use any
              IMDb Software at any time and in such event may modify it to make
              it inoperable. Your rights to use the IMDb Software will
              automatically terminate without notice from us if you fail to
              comply with any of these terms. Additional third party terms
              contained within or distributed with certain IMDb Software that
              are specifically identified in related documentation may apply to
              that IMDb Software and will govern the use of that IMDb Software
              in the event of a conflict with these Conditions of Use.
            </li>
            <li>
              {" "}
              <strong>Use of Third Party Services</strong>. When you use the
              IMDb Software, you may also be using the services of one or more
              third parties, such as a wireless carrier or a mobile platform
            ...
            <li>
              {" "}
              <strong>No Reverse Engineering</strong>. You may not, and you will
              not encourage, assist or authorize any other person to modify,
              reverse engineer, decompile or disassemble, or otherwise tamper
              with, the IMDb Software, whether in whole or in part, or create
              any derivative works from or of the IMDb Software.
            </li>
            <li>
              {" "}
              <strong>Updates</strong>. In order to keep the IMDb Software
              up-to-date, we may offer automatic or manual updates at any time
              and without notice to you.
            </li>
            <li>
              <strong>Export Regulations; Government End Users</strong>. You
              must comply with all export and re-export restrictions and
              regulations of the Department of Commerce and other United States
              agencies and authorities that may apply to the IMDb Software. If
              you are a U.S. Government end user, we are licensing the IMDb
              ...
              the rights we grant you to the IMDb Software are the same as the
              rights we grant to all others under these Conditions of Use.
            </li>
          </ol>
        </section>
      </div>
